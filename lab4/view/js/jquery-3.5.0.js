...
function to_vip() { window.scrollTo(0, 612); } // Di chuyển tới VIP
function to_tool() { window.scrollTo(0, 1041); } // Di chuyển tới TOOL
function to_project() { window.scrollTo(0, 2541); } // Di chuyển tới PROJECT
function to_help() { window.scrollTo(0, 3260); } // Di chuyển tới HELP
/*!
